...
function EditItem() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/user/view-items'), 2000);
    } catch (err) {
      ...
      <Box className="dynamic-fields-wrapper">
        ...
        {mainCategory === 'pets' && (
          <>
            ...
            <TextField fullWidth required label="Color / Markings" name="color" value={formData.color || ''} onChange={handleChange} InputProps={{ startAdornment: <InputAdornment position="start"><FaPalette /></InputAdornment> }} error={!!formErrors.color} helperText={formErrors.color} />
          </>
        )}
        {mainCategory === 'electronics' && (
          <>
            ...
            <TextField fullWidth required label="Color" name="color" value={formData.color || ''} onChange={handleChange} InputProps={{ startAdornment: <InputAdornment position="start"><FaPalette /></InputAdornment> }} error={!!formErrors.color} helperText={formErrors.color} />
          </>
        )}
        {mainCategory === 'accessories' && (
          <>
            <TextField fullWidth required label="Item Name" name="itemName" value={formData.itemName || ''} onChange={handleChange} InputProps={{ startAdornment: <InputAdornment position="start"><FaTag /></InputAdornment> }} error={!!formErrors.itemName} helperText={formErrors.itemName} />
            <TextField fullWidth required label="Brand" name="brand" value={formData.brand || ''} onChange={handleChange} InputProps={{ startAdornment: <InputAdornment position="start"><FaBuilding /></InputAdornment> }} error={!!formErrors.brand} helperText={formErrors.brand} />
            <TextField fullWidth required label="Color" name="color" value={formData.color || ''} onChange={handleChange} InputProps={{ startAdornment: <InputAdornment position="start"><FaPalette /></InputAdornment> }} error={!!formErrors.color} helperText={formErrors.color} />
          </>
        )}
