      ...
      <div className="org-registration-page">
        <div className="org-registration-card">
          ...
          <div className="org-registration-form-section">
            ...
            {error && <p className="org-registration-error-message">{error}</p>}

            <form onSubmit={handleSubmit} className="org-registration-form">
              <div className="org-registration-form-group org-registration-logo-upload-group">
                ...
                />
                <div
                  className={`org-registration-logo-uploader ${logoPreview ? 'org-registration-has-image' : ''}`}
                  onClick={handleUploadClick}
                  style={{ backgroundImage: `url(${logoPreview})` }}
                >
                  {!logoPreview && (
                    <div className="org-registration-uploader-placeholder">
                      <FaImage />
                      <span>Upload Logo</span>
                    </div>
                  )}
                  <div className="org-registration-uploader-overlay">
                    <FaPencilAlt />
                  </div>
                </div>
              </div>
