...
import {
  ...
  FaShapes, FaCalendarAlt, FaBuilding, FaSyncAlt, FaSignature, FaPalette,
...
function OrganaisationFounds() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Found item report submitted successfully!');
      setFormData(initialFormData);
      setItemImage(null);
      setImagePreview('');
      setMainCategory('');
    ...
    <Box className="add-item-container">
      <Paper elevation={0} variant="outlined" className="add-item-paper">
        <Box className="paper-header">
          ...
          <Typography variant="body1" color="text.secondary">Report an item found and brought to your organization.</Typography>
        </Box>
        ...
        <Box component="form" className="add-item-content" onSubmit={handleSubmit} noValidate>
          ...
          <Box className="item-form-section">
            <Box className="form-step-group">
              <Typography variant="overline" className="step-header">Step 1: What was found?</Typography>
...
export default OrganaisationFounds;